...
// We wrap the function inside React.forwardRef and add the "ref" parameter
const Button = React.forwardRef(({ children, type, onClick, classes }, ref) => {
  ...
  if (type === "primary") {
    return (
      <button
        ref={ref} // Pass the ref down onto the HTML element
        onClick={onClick}
        type="button"
...
// Set a display name so React devtools can label it clearly
